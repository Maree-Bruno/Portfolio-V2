...
<?php get_header(); ?>
	...
	<section class="about flex flex-col" id="about">
		...
		<div class="about-main flex flex-row justify-between">
			...
			<div class="about-content flex flex-col">
				...
				<div class="about-content-description font-span">
			...
			<div class="about-career flex flex-col ">
                ...
                <?php if (have_rows('career')): ?>
					<ul class="about-career-list flex flex-col">
	...
	<section class="project project-section flex flex-col">
		...
		<div class="project-container flex flex-row justify-evenly">
            <?php
